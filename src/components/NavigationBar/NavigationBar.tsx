                ...
                <div className="container-xl px-2 px-sm-3">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="me-auto justify-content-center">
                            {role == '2' &&
                                <Nav.Item>
                                    <Link to="/banknotes/admin" className={`${isActive('/banknotes/admin') ? 'active-link' : 'custom-link'} ps-0}`}>
                                        Таблица купюр
                                    </Link>
                                </Nav.Item>
                            }
                            <Nav.Item className="mx-3">
                                <Link to="/banknotes" className={`${isActive('/banknotes') ? 'active-link' : 'custom-link'} ps-0}`}>
                                    Купюры
                                </Link>
                            </Nav.Item>
                            <Nav.Item>
